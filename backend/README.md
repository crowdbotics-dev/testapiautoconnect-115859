...
## Project Structure
    ...
    ├── testapiautoconnect_115859  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_115859`
...
2. Clone this repo and `cd testapiautoconnect_115859`
